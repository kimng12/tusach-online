...
const productsData = {
    ...
    1: {
        ...
        image: "image/Tôi Thấy Hoa Vàng Trên Cỏ Xanh – Nguyễn Nhật Ánh.jpeg",
        rating: 4.9,
        reviewCount: 1240,
    ...
    2: {
        ...
        category: "van-hoc-viet-nam",
        categoryName: "Văn học Việt Nam",
        image: "image/Cánh Đồng Bất Tận – Nguyễn Ngọc Tư.jpeg",
        rating: 4.8,
        reviewCount: 890,
    ...
    3: {
        ...
        category: "van-hoc-viet-nam",
        categoryName: "Văn học Việt Nam",
        image: "image/Chí Phèo – Nam Cao.jpeg",
        rating: 4.7,
        reviewCount: 2100,
    ...
    4: {
        ...
        image: "image/Nhà Giả Kim – Paulo Coelho.jpeg",
        rating: 4.9,
        reviewCount: 3200,
    ...
    5: {
        ...
        category: "van-hoc-nuoc-ngoai",
        categoryName: "Văn học nước ngoài",
        image: "image/Hoàng Tử Bé – Antoine de Saint-Exupéry.jpeg",
        rating: 4.8,
        reviewCount: 1800,
    ...
    6: {
        ...
        category: "van-hoc-nuoc-ngoai",
        categoryName: "Văn học nước ngoài",
        image: "image/Chuông Nguyện Hồn Ai – Ernest Hemingway.jpeg",
        rating: 4.6,
        reviewCount: 950,
    ...
    7: {
        ...
        image: "image/Từ Tốt Đến Vĩ Đại – Jim Collins.jpeg",
        rating: 4.8,
        reviewCount: 1500,
    ...
    8: {
        ...
        category: "kinh-te-quan-tri",
        categoryName: "Kinh tế - Quản trị",
        image: "image/Khởi Nghiệp Tinh Gọn – Eric Ries.jpeg",
        rating: 4.9,
        reviewCount: 2200,
    ...
    9: {
        ...
        category: "kinh-te-quan-tri",
        categoryName: "Kinh tế - Quản trị",
        image: "image/Cha Giàu Cha Nghèo – Robert Kiyosaki.jpeg",
        rating: 4.8,
        reviewCount: 5000,
    ...
    10: {
        ...
        image: "image/Đắc Nhân Tâm – Dale Carnegie.jpeg",
        rating: 4.9,
        reviewCount: 5000,
    ...
    11: {
        ...
        category: "ky-nang-song",
        categoryName: "Kỹ năng sống & Phát triển bản thân",
        image: "image/7 Thói Quen Hiệu Quả – Stephen R. Covey.jpeg",
        rating: 4.8,
        reviewCount: 2800,
    ...
    12: {
        ...
        category: "ky-nang-song",
        categoryName: "Kỹ năng sống & Phát triển bản thân",
        image: "image/Tôi Tài Giỏi, Bạn Cũng Thế! – Adam Khoo.jpeg",
        rating: 4.7,
        reviewCount: 1600,
    ...
    13: {
        ...
        image: "image/Đàn Ông Sao Hỏa, Đàn Bà Sao Kim – John Gray.jpeg",
        rating: 4.7,
        reviewCount: 1900,
    ...
    14: {
        ...
        category: "tam-ly-tinh-cam",
        categoryName: "Tâm lý - Tình cảm",
        image: "image/Yêu Những Điều Không Hoàn Hảo – Haemin Sunim.jpeg",
        rating: 4.9,
        reviewCount: 1200,
    ...
    15: {
        ...
        category: "tam-ly-tinh-cam",
        categoryName: "Tâm lý - Tình cảm",
        image: "image/Tâm Lý Học Về Tiền – Morgan Housel.jpeg",
        rating: 4.8,
        reviewCount: 800,
    ...
    16: {
        ...
        image: "image/Lược Sử Loài Người – Yuval Noah Harari.jpeg",
        rating: 4.9,
        reviewCount: 3500,
    ...
    17: {
        ...
        category: "lich-su-van-hoa",
        categoryName: "Lịch sử - Văn hóa",
        image: "image/Việt Nam Sử Lược – Trần Trọng Kim.jpeg",
        rating: 4.7,
        reviewCount: 1100,
    ...
    18: {
        ...
        category: "lich-su-van-hoa",
        categoryName: "Lịch sử - Văn hóa",
        image: "image/Lược Sử Thời Gian – Stephen Hawking.jpeg",
        rating: 4.8,
        reviewCount: 1800,
    ...
    19: {
        ...
        image: "image/Vũ Trụ Trong Vỏ Hạt Dẻ – Stephen Hawking.jpeg",
        rating: 4.9,
        reviewCount: 900,
    ...
    20: {
        ...
        category: "khoa-hoc-cong-nghe",
        categoryName: "Khoa học - Công nghệ",
        image: "image/Cỗ Máy Tri Giác – Amir Husain.jpeg",
        rating: 4.6,
        reviewCount: 600,
    ...
    21: {
        ...
        category: "khoa-hoc-cong-nghe",
        categoryName: "Khoa học - Công nghệ",
        image: "image/Tư Duy Nhanh Và Chậm – Daniel Kahneman.jpeg",
        rating: 4.7,
        reviewCount: 2500,
    ...
    22: {
        ...
        image: "image/Những Câu Chuyện Cổ Tích Việt Nam.jpeg",
        rating: 4.7,
        reviewCount: 800,
    ...
    23: {
        ...
        category: "thieu-nhi",
        categoryName: "Thiếu nhi",
        image: "image/Harry Potter Và Hòn Đá Phù Thủy – J.K. Rowling.jpeg",
        rating: 5.0,
        reviewCount: 4500,
    ...
    24: {
        ...
        category: "thieu-nhi",
        categoryName: "Thiếu nhi",
        image: "image/Chú Bé Mang Pyjama Sọc – John Boyne.jpeg",
        rating: 4.8,
        reviewCount: 1200,
    ...
    25: {
        ...
        image: "image/Đọc Sách Như Một Nghệ Thuật – Mortimer Adler.jpeg",
        rating: 4.8,
        reviewCount: 700,
    ...
    26: {
        ...
        category: "giao-duc-hoc-tap",
        categoryName: "Giáo dục - Học tập",
        image: "image/Deep Work – Cal Newport.jpeg",
        rating: 4.9,
        reviewCount: 1300,
    ...
    27: {
        ...
        category: "giao-duc-hoc-tap",
        categoryName: "Giáo dục - Học tập",
        image: "image/Hình dạngLàm Chủ Tư Duy, Thay Đổi Vận Mệnh – Adam Khoo.jpeg",
        rating: 4.7,
        reviewCount: 900,
    ...
    28: {
        ...
        image: "image/English Grammar In Use – Raymond Murphy.jpeg",
        rating: 5.0,
        reviewCount: 2000,
    ...
    29: {
        ...
        category: "ngoai-ngu",
        categoryName: "Sách ngoại ngữ",
        image: "image/3000 Từ Vựng Tiếng Anh Thông Dụng Nhất.jpeg",
        rating: 4.8,
        reviewCount: 1500,
    ...
    30: {
        ...
        category: "ngoai-ngu",
        categoryName: "Sách ngoại ngữ",
        image: "image/Minna No Nihongo – Tập 1.jpeg",
        rating: 4.9,
        reviewCount: 800,
